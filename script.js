(() => {
	...
	audio.play().then(() => {
		// Se a reprodução for bem-sucedida, oculta o botão.
		playPauseButton.style.display = 'none';
	}).catch((error) => {
		// Se o autoplay for bloqueado, mostra o botão e aguarda interação.
		console.log('Autoplay bloqueado:', error);
		playPauseButton.style.display = 'block';
		playPauseButton.textContent = '▶️';

		// Adiciona um listener para qualquer clique na página para tentar reproduzir o áudio novamente.
...
function onUserInteraction() {
	audio.play().then(() => {
		// Se o áudio começar a tocar após a interação, oculta o botão e remove o listener.
		playPauseButton.style.display = 'none';
